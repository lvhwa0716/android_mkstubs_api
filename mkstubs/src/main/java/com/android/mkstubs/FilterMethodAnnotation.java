...
public class FilterMethodAnnotation extends MethodVisitor {
	private static final String TAG = "FilterMethodAnnotation: ";
	private String mFilterName;
	private Logger mLog;
	private Filter mFilter;
    public FilterMethodAnnotation(MethodVisitor mw,
